-- [ Nouveau Universal PC Executor Wrapper ] --
...
if not Success then
    warn("[Nouveau Error]: " .. tostring(ErrorMessage))
    if game:GetService("CoreGui"):FindFirstChild("NouveauNotify") then
        game:GetService("CoreGui").NouveauNotify:Destroy()
    end
    
    local ScreenGui = Instance.new("ScreenGui")
    ScreenGui.Name = "NouveauNotify"
    ...
    TextLabel.Text = "Script Error: " .. tostring(ErrorMessage)
